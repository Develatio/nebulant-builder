...
import { StopInstanceSettings } from "@src/components/settings/aws/StopInstanceSettings";

import { BaseDiagramMigrator } from "@src/components/implementations/base/migrators/BaseDiagramMigrator";

import StopInstanceIcon from "@src/assets/img/icons/aws/ec2.svg";
    ...
    this.schema = object({
      ...
      outputs: object({
        result: result.clone().shape({
          ...
          waiters: result.fields.waiters.default(["WaitUntilInstanceStopped"]),
...
export const StopInstanceStatic = {
  label: "Stop instance",
  icon: StopInstanceIcon,
...
export const StopInstanceFns = {
  init() {
    this.validator = new Validator();
    this.migrator = new Migrator();
    this.settingsTemplate = StopInstanceSettings;
  }
};
