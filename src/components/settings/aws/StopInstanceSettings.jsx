...
export const StopInstanceSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>AWS - Stop Instance</WHeader>
      ...
      <WBody>
        ...
        <AdvancedSettings>
          <Waiters
            ...
            toggle_help_text="Don't wait for the instance to be stopped"
            dropdown_help_text="The state(s) which the instance should reach before allowing the execution to continue"
            options={[
              {
                type: "value",
                label: "Wait until instance has stopped",
                value: "WaitUntilInstanceStopped",
              },
            ]}
          />
