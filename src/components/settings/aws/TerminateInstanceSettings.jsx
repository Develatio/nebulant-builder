...
export const TerminateInstanceSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>AWS - Terminate instance</WHeader>
      ...
      <WBody>
        ...
        <AdvancedSettings>
          <Waiters
            ...
            toggle_help_text="Don't wait for the instance to be terminated"
            dropdown_help_text="The state(s) which the instance should reach before allowing the execution to continue"
            options={[
              {
                type: "value",
                label: "Wait until instance has been terminated",
                value: "WaitUntilInstanceTerminated",
              },
            ]}
          />
