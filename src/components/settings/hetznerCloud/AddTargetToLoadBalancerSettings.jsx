...
export const AddTargetToLoadBalancerSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner Cloud - Add target to load balancer</WHeader>
            ...
            <Col sm={12}>
              <Nav variant="pills d-flex justify-content-center align-items-center stylish-tabs">
                <div className="tabsWrapper d-flex">
                  <Nav.Link onClick={() => props.form.set("parameters._activeTab", "servers")} eventKey="servers">Add servers</Nav.Link>
                  <Nav.Link onClick={() => props.form.set("parameters._activeTab", "labels")} eventKey="labels">Add label</Nav.Link>
                </div>
              </Nav>
            </Col>
          </Row>
              ...
              <Row>
                <Col sm={6}>
                  <CheckboxInput
                    form={props.form}
                    validations={props.validations}
                    path={"parameters.UsePrivateIp"}
                    label={"Use private IP"}
                    help_text={"Enable if you want to redirect traffic to the private IP of the server"}
                  ></CheckboxInput>
                </Col>
              </Row>
            </Tab.Pane>
