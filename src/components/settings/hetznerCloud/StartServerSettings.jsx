...
export const StartServerSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner Cloud - Start server</WHeader>
      ...
      <WBody>
        ...
        <AdvancedSettings>
          <Waiters
            {...props}
            toggle_help_text="Don't wait for the server to get started"
          />
