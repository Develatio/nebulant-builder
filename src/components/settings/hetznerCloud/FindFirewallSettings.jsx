...
export const FindFirewallSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner Cloud - Find firewall</WHeader>
      ...
      <WBody>
            ...
            <Col sm={12}>
              <Nav variant="pills d-flex justify-content-center align-items-center stylish-tabs">
                <div className="tabsWrapper d-flex">
                  ...
                  {
                    props.node.prop("data/id") === "find-firewall" ? (
              ...
              <Row className="my-3">
                <Col sm={6}>
                  <TextInput
                    ...
                    help_text={"The name that will be used to filter the firewall."}
                  ></TextInput>
                </Col>
        ...
        <AdvancedSettings>
          {
            props.node.prop("data/id") === "find-firewalls" ? (
              <Paging {...props} />
            ) : ""
          }
          <MaxRetries {...props} />
