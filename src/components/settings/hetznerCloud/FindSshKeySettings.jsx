...
export const FindSshKeySettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner Cloud - Find SSH key</WHeader>
      ...
      <WBody>
            ...
            <Col sm={12}>
              <Nav variant="pills d-flex justify-content-center align-items-center stylish-tabs">
                <div className="tabsWrapper d-flex">
                  ...
                  {
                    props.node.prop("data/id") === "find-ssh-key" ? (
              ...
              <Row className="my-3">
                <Col sm={6}>
                  <TextInput
                    ...
                    help_text={"The name that will be used to filter the SSH key."}
                  ></TextInput>
                </Col>
        ...
        <AdvancedSettings>
          {
            props.node.prop("data/id") === "find-ssh-keys" ? (
              <Paging {...props} />
            ) : ""
          }
