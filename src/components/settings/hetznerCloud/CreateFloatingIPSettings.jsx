...
export const CreateFloatingIPSettings = (props) => {
  return (
    <Container>
      <WHeader help={props.help}>Hetzner cloud - Create floating IP</WHeader>
      ...
      <WBody>
        <Row>
          <Col sm={6}>
            <TextInput
              ...
              help_text={"The name that will be assigned to the created floating IP."}
            ></TextInput>
          </Col>
          ...
          <Col sm={6}>
            <DropdownInput
              ...
              label={"Location"}
              help_text={"The location in which the floating IP will be created."}
              editable={true}
              multi={false}
              options={[
                ...
                >
                  {
                    value.name == "label" && (
                      <DualTextInput
                        ...
                        help_text1={"Add labels to the created floating IP."}
                        className="mb-0"
                      ></DualTextInput>
                    )
                  }
        ...
        <AdvancedSettings>
          <Waiters
            {...props}
            toggle_help_text="Don't wait for the floating IP to get created"
          />
