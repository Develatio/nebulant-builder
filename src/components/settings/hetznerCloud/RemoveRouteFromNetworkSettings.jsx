...
export const RemoveRouteFromNetworkSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Remove route from network</WHeader>
      ...
      <WBody>
        ...
        <AdvancedSettings>
          <Waiters
            {...props}
            toggle_help_text="Don't wait for the route to get removed from the network"
          />
