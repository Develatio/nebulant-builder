...
export const UnassignPrimaryIPSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner cloud - Unassign primary IP</WHeader>
        ...
        <Row>
          <Col sm={12}>
            <DropdownInput
              ...
              label={"Primary IP ID"}
              help_text={"Unassign a primary IP by it's ID."}
              editable={true}
              multi={false}
              options={[
