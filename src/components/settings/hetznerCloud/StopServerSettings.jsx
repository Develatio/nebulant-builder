...
export const StopServerSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner Cloud - Stop server</WHeader>
      ...
      <WBody>
        ...
        <AdvancedSettings>
          <Waiters
            {...props}
            toggle_help_text="Don't wait for the server to get stopped"
          />
