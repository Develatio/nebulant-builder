...
export const UnassignFloatingIPSettings = (props) => {
  ...
  return (
    <Container>
      <WHeader help={props.help}>Hetzner cloud - Unassign floating IP</WHeader>
      ...
      <WBody>
        <Row>
          <Col sm={12}>
            <DropdownInput
              ...
              help_text={"Unassign a floating IP by it's ID."}
              editable={true}
              multi={false}
              options={[
        ...
        <AdvancedSettings>
          <Waiters
            {...props}
            toggle_help_text="Don't wait for the floating IP to get unassigned"
          />
