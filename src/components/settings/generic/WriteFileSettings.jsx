...
export const WriteFileSettings = (props) => {
  return (
    <Container>
      <WHeader help={props.help}>GENERIC - Write File</WHeader>
        ...
        <Row className="mt-3">
          ...
          <Col sm={12}>
            <CodeEditor
              ...
              placeholder={"The content of the file you wish to write"}
            />
          </Col>
          ...
          <Col sm={12}>
            <CheckboxInput
              ...
              label={"Interpolate"}
              help_text={"Interpolate the content of the file while writing it"}
            ></CheckboxInput>
          </Col>
        </Row>
