  ...
  "blueprint": {
    "diagram": {
      "cells": [
        ...
        },
        {
            ...
            "items": [
              {
                "group": "in",
                "attrs": {},
                "id": "0775b57d-0c33-450d-8347-a4a96991a3fe"
              },
              {
                "group": "out-ko",
                "attrs": {},
                "id": "7556ed96-9877-4052-a00d-60a84960ab53"
              },
              {
                "group": "out-ok",
                "attrs": {},
                "id": "6eafbbf1-0781-423c-a40f-df8ce521a456"
              }
            ]
          },
          "position": {
          ...
          "angle": 0,
          "id": "d2d776f2-0391-4254-82ec-37670435c838",
          "z": 700
        },
        {
    ...
    "actions": [
      ...
      },
      {
        ...
        "action": "log",
        "parameters": {
          "content": "Starting workflow: {{ AWS_SERVER }}"
        },
        "next_action": {
          "ok": [
      ...
      },
      {
        ...
        "action": "log",
        "parameters": {
          "content": "Ending workflow:  {{ AWS_SERVER }}"
        },
        "next_action": {},
        "debug_network": false
      }
