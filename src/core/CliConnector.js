...
export const CliConnectorStates = {
  ...
  pausing: 5,
  stopping: 6,
  waiting_for_cli_state: 7,
};

const CLI_STATE_2_CONNECTIVITY_STATE = {
  [CliEventStates.STARTED_PROCESSING_BP]: CliConnectorStates.running,
  [CliEventStates.FINISHED_PROCESSING_BP]: CliConnectorStates.running,
  [CliEventStates.ERROR_PROCESSING_BP]: CliConnectorStates.connected,
  [CliEventStates.STARTING_MANAGER]: CliConnectorStates.running,
